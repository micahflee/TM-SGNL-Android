...
/* loaded from: input.aar:classes.jar:com/tm/androidcopysdk/recorder/igalCode/IgalAudioRecord.class */
public class IgalAudioRecord {
    ...
    public IgalAudioRecord(int audiosource, int samplerate, int audioformat, int channels, int size) {
