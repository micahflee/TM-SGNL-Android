...
val canonicalVersionCode = 1414
val canonicalVersionName = "7.2.4.4"
val signal_teleMessage_version = "7.2.4.4"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
