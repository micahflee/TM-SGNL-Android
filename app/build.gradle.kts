...
val canonicalVersionCode = 1345
val canonicalVersionName = "6.44.3.5"
val signal_teleMessage_version = "6.44.3.5"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
