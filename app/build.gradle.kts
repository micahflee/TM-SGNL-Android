...
val canonicalVersionCode = 1339
val canonicalVersionName = "6.44.2.2"
val signal_teleMessage_version = "6.44.2.2"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
