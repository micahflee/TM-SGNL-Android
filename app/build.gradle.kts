...
val canonicalVersionCode = 1415
val canonicalVersionName = "7.2.4.5"
val signal_teleMessage_version = "7.2.4.5"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
