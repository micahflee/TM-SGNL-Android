...
val canonicalVersionCode = 1425
val canonicalVersionName = "7.2.4.15"
val signal_teleMessage_version = "7.2.4.15"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
