...
val canonicalVersionCode = 1342
val canonicalVersionName = "6.44.2.5"
val signal_teleMessage_version = "6.44.2.5"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
