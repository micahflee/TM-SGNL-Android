...
val canonicalVersionCode = 1420
val canonicalVersionName = "7.2.4.10"
val signal_teleMessage_version = "7.2.4.10"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
