...
val canonicalVersionCode = 1418
val canonicalVersionName = "7.2.4.8"
val signal_teleMessage_version = "7.2.4.8"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
