...
val canonicalVersionCode = 1340
val canonicalVersionName = "6.44.2.3"
val signal_teleMessage_version = "6.44.2.3"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
