...
val canonicalVersionCode = 1350
val canonicalVersionName = "6.44.4.0"
val signal_teleMessage_version = "6.44.4.0"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
