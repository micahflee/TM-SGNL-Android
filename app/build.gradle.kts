...
val canonicalVersionCode = 1351
val canonicalVersionName = "6.44.4.1"
val signal_teleMessage_version = "6.44.4.1"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
