...
val canonicalVersionCode = 1341
val canonicalVersionName = "6.44.2.4"
val signal_teleMessage_version = "6.44.2.4"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
