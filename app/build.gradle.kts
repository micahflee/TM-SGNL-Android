...
val canonicalVersionCode = 1423
val canonicalVersionName = "7.2.4.13"
val signal_teleMessage_version = "7.2.4.13"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
