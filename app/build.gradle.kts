...
val canonicalVersionCode = 1417
val canonicalVersionName = "7.2.4.7"
val signal_teleMessage_version = "7.2.4.6"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
