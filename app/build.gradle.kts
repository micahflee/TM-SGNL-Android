...
val canonicalVersionCode = 1346
val canonicalVersionName = "6.44.3.6"
val signal_teleMessage_version = "6.44.3.6"//Change this param in Jenkins builder and delete it.
//**TM_SA**//end
