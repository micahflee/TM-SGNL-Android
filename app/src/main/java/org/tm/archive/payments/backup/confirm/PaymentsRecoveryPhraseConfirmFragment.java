package org.tm.archive.payments.backup.confirm;
...
public class PaymentsRecoveryPhraseConfirmFragment extends Fragment {
  ...
  public static final  String   REQUEST_KEY_RECOVERY_PHRASE = "org.tm.archive.payments.backup.confirm.RECOVERY_PHRASE";
