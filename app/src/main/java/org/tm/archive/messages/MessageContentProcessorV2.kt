...
import org.tm.archive.messages.SignalServiceProtoUtil.hasDisallowedAnnouncementOnlyContent
import org.tm.archive.messages.SignalServiceProtoUtil.hasGroupContext
import org.tm.archive.messages.SignalServiceProtoUtil.hasSignedGroupChange
import org.tm.archive.messages.SignalServiceProtoUtil.hasStarted
...
import org.tm.archive.messages.SignalServiceProtoUtil.isValid
import org.tm.archive.messages.SignalServiceProtoUtil.signedGroupChange
import org.tm.archive.messages.SignalServiceProtoUtil.toDecryptionErrorMessage
...
open class MessageContentProcessorV2(private val context: Context) {
  ...
  private fun handleMessage(
    ...
    when {
      content.hasDataMessage() -> { //incoming message
      ...
      content.hasReceiptMessage() -> {
        ReceiptMessageProcessor.process(
          ...
          if (processingEarlyContent)
          {
            ...
            EarlyMessageCacheEntry(envelope, content, metadata, serverDeliveredTimestamp)
          }
        )
