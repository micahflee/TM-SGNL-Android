...
import org.tm.archive.database.model.ServiceMessageId
import org.tm.archive.dependencies.ApplicationDependencies
import org.tm.archive.jobmanager.Job
import org.tm.archive.messages.MessageContentProcessor
import org.tm.archive.messages.MessageContentProcessorV2
import org.tm.archive.util.EarlyMessageCacheEntry
import org.whispersystems.signalservice.api.messages.SignalServiceContent

/**
 * A job that should be enqueued whenever we process a message that we think has arrived "early" (see [org.tm.archive.util.EarlyMessageCache]).
