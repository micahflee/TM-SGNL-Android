...
import org.tm.archive.storage.AccountRecordProcessor;
import org.tm.archive.storage.ContactRecordProcessor;
import org.tm.archive.storage.GroupV1RecordProcessor;
import org.tm.archive.storage.GroupV2RecordProcessor;
import org.tm.archive.storage.StorageRecordUpdate;
import org.tm.archive.storage.StorageSyncHelper;
import org.tm.archive.storage.StorageSyncHelper.IdDifferenceResult;
import org.tm.archive.storage.StorageSyncHelper.WriteOperationResult;
...
public class StorageSyncJob extends BaseJob {
  ...
  private boolean performSync() throws IOException, RetryLaterException, InvalidKeyException {
    ...
    try {
       remoteManifest = accountManager.getStorageManifestIfDifferentVersion(storageServiceKey, localManifest.getVersion()).or(localManifest);
    }catch (Exception e){
