package org.tm.archive.avatar.picker
...
import org.tm.archive.avatar.photo.PhotoEditorActivity
import org.tm.archive.avatar.photo.PhotoEditorFragment
import org.tm.archive.avatar.text.TextAvatarCreationFragment
import org.tm.archive.avatar.vector.VectorAvatarCreationFragment
import org.tm.archive.components.ButtonStripItemView
...
class AvatarPickerFragment : Fragment(R.layout.avatar_picker_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_SELECT_AVATAR = "org.tm.archive.avatar.picker.SELECT_AVATAR"
    const val SELECT_AVATAR_MEDIA = "org.tm.archive.avatar.picker.SELECT_AVATAR_MEDIA"
    const val SELECT_AVATAR_CLEAR = "org.tm.archive.avatar.picker.SELECT_AVATAR_CLEAR"
