...
import org.tm.archive.jobs.ClearFallbackKbsEnclaveJob;
...
import org.tm.archive.registration.service.KeyBackupSystemWrongPinException;
...
public final class PinState {
  ...
  /**
   * Should only be called by {@link org.tm.archive.migrations.RegistrationPinV2MigrationJob}.
   */
  @WorkerThread
  ...
  /**
   * Should only be called by {@link org.tm.archive.jobs.KbsEnclaveMigrationWorkerJob}.
   */
  @WorkerThread
