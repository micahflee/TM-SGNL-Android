...
open class MiscellaneousValues internal constructor(store: KeyValueStore) : SignalStoreValues(store) {//**TM_SA**//make open
  companion object {
   ...
   */
  open var isClientDeprecated: Boolean by booleanValue(CLIENT_DEPRECATED, false)//**TM_SA**//make open
  ...
  /**
   * The last time we ran an account consistency check via [org.tm.archive.jobs.AccountConsistencyWorkerJob]
   */
