...
import org.tm.archive.util.safeUnregisterReceiver
import org.tm.archive.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [org.tm.archive.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [org.tm.archive.webrtc.audio.SignalAudioManager].
 */
