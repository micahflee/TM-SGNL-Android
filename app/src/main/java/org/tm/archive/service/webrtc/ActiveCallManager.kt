...
import org.tm.archive.service.SafeForegroundService
...
import org.tm.archive.webrtc.audio.AudioManagerCommand
import org.tm.archive.webrtc.audio.SignalAudioManager
import org.tm.archive.webrtc.audio.SignalAudioManager.Companion.create
...
class ActiveCallManager(
  ...
  class ActiveCallServiceReceiver : BroadcastReceiver() {
    ...
    companion object {
      const val ACTION_DENY = "org.tm.archive.service.webrtc.ActiveCallAction.DENY"
      const val ACTION_HANGUP = "org.tm.archive.service.webrtc.ActiveCallAction.HANGUP"
    }
