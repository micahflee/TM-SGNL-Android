...
import static org.tm.archive.service.WebRtcCallService.EXTRA_GROUP_CALL_ERA_ID;
import static org.tm.archive.service.WebRtcCallService.EXTRA_GROUP_CALL_UPDATE_GROUP;
import static org.tm.archive.service.WebRtcCallService.EXTRA_GROUP_CALL_UPDATE_SENDER;
import static org.tm.archive.service.WebRtcCallService.EXTRA_HANGUP_DEVICE_ID;
import static org.tm.archive.service.WebRtcCallService.EXTRA_HANGUP_IS_LEGACY;
import static org.tm.archive.service.WebRtcCallService.EXTRA_HANGUP_TYPE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_HTTP_REQUEST_ID;
import static org.tm.archive.service.WebRtcCallService.EXTRA_HTTP_RESPONSE_BODY;
import static org.tm.archive.service.WebRtcCallService.EXTRA_HTTP_RESPONSE_STATUS;
import static org.tm.archive.service.WebRtcCallService.EXTRA_MESSAGE_AGE_SECONDS;
import static org.tm.archive.service.WebRtcCallService.EXTRA_SERVER_DELIVERED_TIMESTAMP;
import static org.tm.archive.service.WebRtcCallService.EXTRA_SERVER_RECEIVED_TIMESTAMP;
import static org.tm.archive.service.webrtc.WebRtcIntentParser.getRecipientId;
import static org.tm.archive.service.webrtc.WebRtcIntentParser.getRemoteDevice;
