...
import org.tm.archive.ringrtc.TurnServerInfoParcel;
...
import static org.tm.archive.service.WebRtcCallService.EXTRA_ANSWER_OPAQUE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_ANSWER_SDP;
import static org.tm.archive.service.WebRtcCallService.EXTRA_AVAILABLE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_BROADCAST;
import static org.tm.archive.service.WebRtcCallService.EXTRA_CALL_ID;
import static org.tm.archive.service.WebRtcCallService.EXTRA_CAMERA_STATE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_ENABLE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_ERROR_CALL_STATE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_ERROR_IDENTITY_KEY;
import static org.tm.archive.service.WebRtcCallService.EXTRA_GROUP_CALL_END_REASON;
import static org.tm.archive.service.WebRtcCallService.EXTRA_GROUP_CALL_HASH;
import static org.tm.archive.service.WebRtcCallService.EXTRA_GROUP_EXTERNAL_TOKEN;
import static org.tm.archive.service.WebRtcCallService.EXTRA_ICE_CANDIDATES;
import static org.tm.archive.service.WebRtcCallService.EXTRA_MULTI_RING;
import static org.tm.archive.service.WebRtcCallService.EXTRA_OFFER_OPAQUE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_OFFER_SDP;
import static org.tm.archive.service.WebRtcCallService.EXTRA_OFFER_TYPE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_OPAQUE_MESSAGE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_ORIENTATION_DEGREES;
import static org.tm.archive.service.WebRtcCallService.EXTRA_REMOTE_DEVICE;
import static org.tm.archive.service.WebRtcCallService.EXTRA_REMOTE_IDENTITY_KEY;
import static org.tm.archive.service.WebRtcCallService.EXTRA_REMOTE_PEER_KEY;
import static org.tm.archive.service.WebRtcCallService.EXTRA_TURN_SERVER_INFO;
import static org.tm.archive.service.WebRtcCallService.EXTRA_UUID;
