...
import org.tm.archive.database.StorageKeyDatabase;
...
public class SQLCipherOpenHelper extends SQLiteOpenHelper implements SignalDatabase {
  ...
  public org.tm.archive.database.SQLiteDatabase getReadableDatabase() {
    return new org.tm.archive.database.SQLiteDatabase(getReadableDatabase(databaseSecret.asString()));
  }

  public org.tm.archive.database.SQLiteDatabase getWritableDatabase() {
    return new org.tm.archive.database.SQLiteDatabase(getWritableDatabase(databaseSecret.asString()));
  }
