...
import org.tm.archive.database.SignalDatabase.Companion.stickers
...
import org.tm.archive.jobs.GenerateAudioWaveFormJob
...
open class AttachmentTable( //TM_SA make class open
  context: Context,
  ...
  @Throws(MmsException::class)
  open fun insertAttachmentForPreUpload(attachment: Attachment): DatabaseAttachment { //TM_SA make fun open
  ...
  open fun markAttachmentUploaded(messageId: Long, attachment: Attachment) { //TM_SA make fun open
    writableDatabase
      .update(TABLE_NAME)
