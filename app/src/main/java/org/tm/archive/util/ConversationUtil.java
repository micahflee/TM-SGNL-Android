...
import org.tm.archive.components.settings.app.appearance.appicon.util.AppIconUtility;
...
public final class ConversationUtil {
  ...
  private static final String CATEGORY_SHARE_TARGET = "org.tm.archive.sharing.CATEGORY_SHARE_TARGET";
