...
import org.tm.archive.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link org.tm.archive.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
