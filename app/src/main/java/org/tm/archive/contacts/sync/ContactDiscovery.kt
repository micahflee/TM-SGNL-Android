package org.tm.archive.contacts.sync
...
object ContactDiscovery {
  ...
  private const val MESSAGE_MIMETYPE = "vnd.android.cursor.item/vnd.org.tm.archive.contact"
  private const val CALL_MIMETYPE = "vnd.android.cursor.item/vnd.org.tm.archive.call"
  ...
  fun refreshAll(context: Context, notifyOfNewUsers: Boolean) {
    ...
    //TODO THE FOLLOWING PART NOT NECESSARY IF THE CONTACT AND PIN CODE WORKING WELL
